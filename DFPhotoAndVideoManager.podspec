#
#  Be sure to run `pod spec lint DFPhotoAndVideoManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
			Helps you to retrieve photo and videos from iOS photo album
                   DESC

  s.homepage     = "https://github.com/wangqi03/DFPhotoAndVideoManager"
  ...
  # s.social_media_url   = "http://twitter.com/wanghaojiao"
  ...
  s.source       = { :git => "https://github.com/wangqi03/DFPhotoAndVideoManager.git", :tag => "#{s.version}" }
